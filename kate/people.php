<?php
  ...
  */
  ...
  $query = "SELECT name alt FROM pics WHERE portfolio='". $location . "'";
  ...
  else //if login successful
  {
    ...
    while($row=mysqli_fetch_array($result, MYSQLI_NUM)){
      ...
      $thumbs[$i] ="<div class='blackdiv images" . $num . "' title='images" . $num . "'> <img  width= '60' alt='" . $row[1] . "' class='black hide images" . $num . "' title='image" . $num . "' src='images/" . $location . "/" . $row[0] . "' /></div>";
		$i++;
    } 
  }  
